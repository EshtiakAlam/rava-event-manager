...
const createEvent = async (req, res) => {
    const { title, organizer, date, location, time, description, highlights, FAQ } = req.body;

    try {
        const event = await Event.create({ title, organizer, date, location, time, description, highlights, FAQ, like: 0, approval: false });
